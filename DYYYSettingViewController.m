...
- (void)setupSettingItems {
    self.settingSections = @[
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"全部过滤直播" key:@"DYYYSkipAllLive" type:DYYYSettingItemTypeSwitch],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"设置评论填充" key:@"DYYYCommentContent" type:DYYYSettingItemTypeTextField placeholder:@"善语结善缘，恶言伤人心"],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"移除全屏观看" key:@"DYYYRemoveEntry" type:DYYYSettingItemTypeSwitch],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"禁用直播标签收缩" key:@"DYYYDisableAutoHideLive" type:DYYYSettingItemTypeSwitch],
