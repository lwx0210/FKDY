...
- (void)setupSettingItems {
    self.settingSections = @[
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"启用全屏播放" key:@"DYYYisEnableFullScreen" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"属地时间显示" key:@"DYYYisEnableArea" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"属地颜色随机" key:@"DYYYEnabsuijiyanse" type:DYYYSettingItemTypeSwitch],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"查看评论显示弹幕" key:@"DYYYCommentShowDanmaku" type:DYYYSettingItemTypeSwitch],
